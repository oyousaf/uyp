    ...
    <div className="mx-auto max-w-368">
      <div className="grid gap-10 border-b border-black/15 pb-14 lg:grid-cols-[.7fr_2fr]">
        ...
        <h2 className="display-title text-[clamp(2.8rem,6vw,6.8rem)] leading-[.95]">
          ...
          <span className="block italic text-[#a84420]">
      ...
      <div className="grid gap-12 py-14 lg:grid-cols-2 lg:gap-24">
        ...
        <div className="space-y-6 text-base leading-8 text-black/65 md:text-lg">
          <p>
            We believe every person deserves a fair chance to succeed,
            regardless of background. Our programmes create safe, inclusive
            spaces for collaboration, personal growth and practical learning.
          </p>
          <p>
            By listening to our communities and responding imaginatively, we
            raise aspirations, widen access and help people turn possibility
            into progress.
          </p>
        </div>
      </div>
      <div className="grid overflow-hidden rounded-4xl bg-[#66240f] text-[#fff8ef] md:grid-cols-3">
        {[
          ...
          <article
            key={title}
            className="border-b border-[#fff3e6]/15 p-8 last:border-b-0 md:border-b-0 md:border-r md:last:border-r-0 lg:p-10"
          >
