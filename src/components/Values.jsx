    ...
    <div className="mx-auto max-w-368">
      <div className="mb-14 flex flex-col justify-between gap-8 md:flex-row md:items-end">
        <div>
          ...
          <h2 className="display-title text-[clamp(3.5rem,8vw,8rem)] leading-[.85]">
            Values in{" "}
            <span className="block italic text-[#ffb06f]">action.</span>
          </h2>
        </div>
        <p className="max-w-md text-lg leading-8 text-[#ffd9ba]">
          The principles behind every programme, partnership and conversation.
        </p>
      </div>
      <div className="grid border-t border-[#fff3e6]/20 lg:grid-cols-2">
        {values.map(({ id, title, text }, index) => (
          <article
            key={id}
            className="group relative min-h-72 overflow-hidden border-b border-[#fff3e6]/20 p-7 transition-colors hover:bg-[#7a2e16] md:p-10 lg:odd:border-r"
          >
            <div className="flex items-start justify-between">
              <span className="font-serif text-2xl italic text-[#ffb06f]">
                0{index + 1}
              </span>
            ...
            <div className="mt-14">
              ...
              <p className="mt-4 max-w-lg text-base leading-7 text-[#ffd9ba] group-hover:text-[#fff3e6]">
                {text}.
              </p>
            </div>
          </article>
